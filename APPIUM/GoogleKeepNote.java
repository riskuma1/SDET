...
public class GoogleKeepNote {
	...
	@Test
	public void addNoteGKeep() {
		String heading="Note1";
		...
		driver.findElement(By.id("com.google.android.keep:id/edit_note_text")).sendKeys("This is my note 1");
		
		//back click
		driver.findElement(By.xpath("//android.widget.ImageButton[@content-desc=\"Open navigation drawer\"]")).click();
		
		String actual = driver.findElementByAndroidUIAutomator("text(\"Note1\")").getText();
